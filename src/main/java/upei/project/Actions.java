...
public class Actions {
    ...
    public void createBoxes(){
        ...
        newBoxes[8] = new LandBox("Vermont Avenue",9,null,0,130,"Light Blue");
        newBoxes[9] = new LandBox("Connecticut Avenue",10,null,0,250, "Light Blue");
        newBoxes[10] = new NoActions("Jail / Just Visiting",11);
        newBoxes[11] = new LandBox("St. Charles Place",12,null,0,140,"Pink");
        newBoxes[12] = new Utility("Electric company",13,null,0,140);
        newBoxes[13] = new LandBox("States ave",14,null,0,140,"Pink");
        newBoxes[14] = new LandBox("Virgina ave",15,null,0,140,"Pink");
        newBoxes[15] = new Utility("Railroad",16,null,0,140);
        newBoxes[16] = new LandBox("St. James Place",17,null,0,140,"Orange");
        newBoxes[17] = new CummunityBox("Community chest",18);
        newBoxes[18] = new LandBox("Tennessee ave",19,null,0,140,"Orange");
        newBoxes[19] = new LandBox("New York ave",20,null,0,140,"Orange");
        newBoxes[20] = new NoActions("Free parking",21);
        newBoxes[21] = new LandBox("Kenturkey ave",22,null,0,140,"Red");
        newBoxes[22] = new ChanceBox("Chance",23);
        newBoxes[23] = new LandBox("Indiana ave",24,null,0,140,"Red");
        newBoxes[24] = new LandBox("Illinois ave",25,null,0,140,"Red");
        newBoxes[25] = new Utility("Railroad",26,null,0,140);
        newBoxes[26] = new LandBox("Atlantic ave",27,null,0,140,"Yellow");
        newBoxes[27] = new LandBox("Ventnor ave",28,null,0,140,"Yellow");
        newBoxes[28] = new Utility("Water work",29,null,0,140);
        newBoxes[29] = new LandBox("Mavin gardens",30,null,0,140,"Yellow");
        newBoxes[30] = new NoActions("Go to Jail",31);
        newBoxes[31] = new LandBox("Pacific ave",32,null,0,140,"Green");
        newBoxes[32] = new LandBox("North Carolina ave",33,null,0,140,"Green");
        newBoxes[33] = new CummunityBox("Community chest",34);
        newBoxes[34] = new LandBox("Pennsylvania ave",35,null,0,140,"Green");
